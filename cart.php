...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="home.php"><span>RE Consultancy</span></a>
...
<?php
   ...
   $query="SELECT sellers.*, cart.id as 'cart_id' , cart.order_id FROM sellers 
    Inner join cart ON cart.order_id = sellers.id WHERE cart.user_id = '".$_SESSION['id']."'
    ...
    <div class="col s4">
        <div class="card" style="width: 24rem; height:auto;">
            ...
            <img style="padding:1%; width:340; height:250; margin-left:5.4%;"class="card-img-top" src="images/'.$row['image'].'" alt="Card image cap">
            ...
            <a type="button" cart_id='.$row['cart_id'].' order_id='.$row['order_id'].' class="btn btn-primary delete" style="color: white;" name="delete">Delete</a>
             </div>
        </div><br><br>
    </div>';
    }
      ...
      <!-- Footer -->
        <footer class="page-footer font-small  pt-4" style="background-color: LemonChiffon;">
            ...
            <div class="footer-copyright text-center py-3" style="background-color: moccasin ;">© 2022 Copyright:
                <a href="cart.php">RE Consultancy | Ansari Sadaan</a>
            </div>
            <!-- Copyright -->
        </footer>
        <!-- Footer -->
